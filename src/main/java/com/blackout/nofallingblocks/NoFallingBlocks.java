...
public class NoFallingBlocks {
	...
	public static final GameRules.RuleKey<GameRules.BooleanValue> PREVENT_BLOCK_FALLING_RULE = GameRules.register("preventBlockFalling", GameRules.Category.UPDATES, GameRules.BooleanValue.create(true));
